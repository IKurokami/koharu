...
const {mutation: mutationOptions, request: requestOptions} = options ?
 ...
 , queryClient?: QueryClient): UseMutationResult<
    ...
    export const getImportDirectoryUrl = () => {




  return `/api/v1/projects/import-directory`
}

export const importDirectory = async (importDirectoryRequest: ImportDirectoryRequest, options?: RequestInit): Promise<ProjectSummary> => {

  return fetchApi<ProjectSummary>(getImportDirectoryUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(importDirectoryRequest)
  }
);}
...
export const getImportDirectoryMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof importDirectory>>, TError,{data: ImportDirectoryRequest}, TContext>, request?: SecondParameter<typeof fetchApi>}
): UseMutationOptions<Awaited<ReturnType<typeof importDirectory>>, TError,{data: ImportDirectoryRequest}, TContext> => {

const mutationKey = ['importDirectory'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof importDirectory>>, {data: ImportDirectoryRequest}> = (props) => {
          const {data} = props ?? {};

          return  importDirectory(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ImportDirectoryMutationResult = NonNullable<Awaited<ReturnType<typeof importDirectory>>>
    export type ImportDirectoryMutationBody = ImportDirectoryRequest
    export type ImportDirectoryMutationError = unknown

    export const useImportDirectory = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof importDirectory>>, TError,{data: ImportDirectoryRequest}, TContext>, request?: SecondParameter<typeof fetchApi>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof importDirectory>>,
        TError,
        {data: ImportDirectoryRequest},
        TContext
      > => {
      return useMutation(getImportDirectoryMutationOptions(options), queryClient);
    }
    export const getDeleteProjectByIdUrl = (id: string,) => {
...
export const deleteProjectById = async (id: string, options?: RequestInit): Promise<void> => {

  return fetchApi<void>(getDeleteProjectByIdUrl(id),
  {
    ...options,
    method: 'DELETE'
...
export const getDeleteProjectByIdMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteProjectById>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof fetchApi>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteProjectById>>, TError,{id: string}, TContext> => {

const mutationKey = ['deleteProjectById'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteProjectById>>, {id: string}> = (props) => {
          const {id} = props ?? {};

          return  deleteProjectById(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteProjectByIdMutationResult = NonNullable<Awaited<ReturnType<typeof deleteProjectById>>>

    export type DeleteProjectByIdMutationError = unknown

    export const useDeleteProjectById = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteProjectById>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof fetchApi>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof deleteProjectById>>,
        TError,
        {id: string},
        TContext
      > => {
