...
plugin(webpPlugin);
globalThis.webpPlugin = webpPlugin;
var parsed = parseHTML("<!DOCTYPE html><html><body></body></html>");
var { window: window2, document, customElements: customElements2, HTMLElement: HTMLElement2, Event, DOMParser: DOMParser2, HTMLAnchorElement: HTMLAnchorElement2, HTMLImageElement: HTMLImageElement2, HTMLMetaElement: HTMLMetaElement2 } = parsed;
var urlProperties = ["pathname", "search", "hash", "host", "hostname", "origin", "protocol"];
for (const prop2 of urlProperties) {
  Object.defineProperty(HTMLAnchorElement2.prototype, prop2, {
    get() {
...
var pendingPromises = [];
globalThis.pendingPromises = pendingPromises;
var originalDispatchEvent = HTMLElement2.prototype.dispatchEvent;
HTMLElement2.prototype.dispatchEvent = function(event) {
    ...
    const p = fetch(url, {
      ...
      if (swap === "outerHTML") {
        ...
        if (parent) {
          ...
          const newEl = Array.from(temp.childNodes).find((n) => n.nodeType === 1);
          if (newEl) {
...
globalThis.customElements = customElements2;
globalThis.HTMLElement = HTMLElement2;
globalThis.Event = Event;
globalThis.DOMParser = DOMParser2;
globalThis.HTMLAnchorElement = HTMLAnchorElement2;
globalThis.HTMLImageElement = HTMLImageElement2;
globalThis.HTMLMetaElement = HTMLMetaElement2;
...
var engineDir = join(scriptPath, "..", "..");
await import(join(engineDir, "RegExpSafe.ts"));
await import(join(engineDir, "ArrayExtensions.ts"));
await import(join(engineDir, "platform", "FetchProvider.ts"));
var connectorModule = await import(scriptPath);
var ScraperClass = connectorModule.default;
