...
impl Renderer {
    pub fn new() -> Result<Self> {
        ...
        let _ = fontbook.load_from_bytes(
            include_bytes!("../data/fonts/000CollectEmAlliCiel-Regular.ttf").to_vec(),
        );
        let _ = fontbook.load_from_bytes(
            include_bytes!("../data/fonts/000CollectEmAlliCiel-Italic.ttf").to_vec(),
        );
        let _ = fontbook.load_from_bytes(
            include_bytes!("../data/fonts/000CollectEmAlliCiel-Bold.ttf").to_vec(),
        );
        let _ = fontbook.load_from_bytes(
            include_bytes!("../data/fonts/000CollectEmAlliCiel-BoldItalic.ttf").to_vec(),
        );
